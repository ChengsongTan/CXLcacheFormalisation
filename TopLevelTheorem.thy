...
theorem all_transitions_coherent: assumes "SWMR_state_machine T"
  ...
  show goal69: "Lall (HostModifiedDirtyEvictPrevious' T 0) SWMR_state_machine"
    by (metis HostModifiedDirtyEvictPrevious'_coherent assms)
qed
